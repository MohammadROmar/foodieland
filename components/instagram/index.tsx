...
export default function Instagram() {
  return (
    <section className="max-container space-y-6 pb-8 flex flex-col items-center relative before:absolute before:w-screen before:-z-10 before:top-0 before:bottom-0 before:bg-gradient-to-t before:from-light-blue before:to-transparent">
